...
public class LengthConverter {
    ...
    public LengthConverter(Map<String, Double> options) {this._options = options;}
    public LengthConverter(){
        this._options = new HashMap<String,Double>(){{
            put("Kilómetros a Millas", 1/1.60934);
            put("Millas a Kilómetros", 1.60934);
        }};
    }
    ...
    public void show() {
        ...
        this._selectedOption = (String) JOptionPane
                .showInputDialog(null, "Elige una opción", "Convertir longitud", JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
